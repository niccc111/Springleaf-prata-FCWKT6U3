...
- [ ] 1. Repository scaffold and shared foundations
...
- [ ] 2. Database schema and migrations
  - [ ] 2.1 Write Alembic initial migration creating all tables and indexes from the design SQL
  ...
  - [ ] 2.2 Apply immutability rules for audit_log
  ...
  - [ ]* 2.3 Write property test for audit log immutability (Property 33)
...
- [ ] 3. Audit Service
  - [ ] 3.1 Implement AuditService with atomic transactional logging
  ...
  - [ ]* 3.2 Write property test for audit log completeness (Property 32)
  ...
  - [ ]* 3.3 Write property test for audit write failure rolls back entity change (Property 34)
...
- [ ] 4. Alert Service
  - [ ] 4.1 Implement AlertService core persistence and pub/sub broadcast
  ...
  - [ ]* 4.2 Write property test for alert acknowledgement first-writer-wins (Property 29)
...
- [ ] 5. Route Service — core lifecycle
  - [ ] 5.1 Implement Route and Stop CRUD with status state machine
  ...
  - [ ]* 5.2 Write property test for dispatched routes auto-locked (Property 26)
  ...
  - [ ] 5.3 Implement route locking and unlocking with eligibility enforcement
  ...
  - [ ]* 5.4 Write property test for route locking state machine (Property 24)
  ...
  - [ ] 5.5 Implement manual order reassignment with capacity and time-window validation
  ...
  - [ ]* 5.6 Write property test for reassignment recalculation consistency (Property 20)
  ...
  - [ ]* 5.7 Write property test for reassignment capacity rejection (Property 21)
  ...
  - [ ]* 5.8 Write property test for locked route reassignment rejection (Property 22)
  ...
  - [ ]* 5.9 Write property test for reassignment audit completeness (Property 23)
  ...
  - [ ] 5.10 Implement ETA recalculation and late delivery alert propagation
  ...
  - [ ]* 5.11 Write property test for ETA recalculation downstream consistency (Property 16)
  ...
  - [ ]* 5.12 Write property test for late delivery alerts on time window violation (Property 17)
...
- [ ] 6. Checkpoint — core services baseline
  - Ensure all tests pass, ask the user if questions arise.

- [ ] 7. Geocoding Service
  - [ ] 7.1 Implement GeocodingService wrapping the Mapping Service API
  ...
  - [ ] 7.2 Implement geocoding retry queue processor
  ...
  - [ ]* 7.5 Write property test for coordinate validation (Property 31)
...
- [ ] 8. OMS Integration Adapter
  - [ ] 8.1 Implement OMS event consumer and order ingestion
  ...
  - [ ] 8.2 Implement OMS health watchdog and connectivity warning
  ...
  - [ ]* 8.3 Write property test for OMS event validation (Property 1)
  ...
  - [ ]* 8.4 Write property test for OMS field mapping correctness (Property 2)
  ...
  - [ ]* 8.5 Write property test for OMS deduplication idempotency (Property 3)
...
- [ ] 9. FMS Integration Adapter
  - [ ] 9.1 Implement FMS event consumer and vehicle upsert logic
  ...
  - [ ] 9.2 Implement FMS stale-data fallback and connectivity warning
  ...
  - [ ]* 9.3 Write property test for FMS vehicle creation correctness (Property 4)
  ...
  - [ ]* 9.4 Write property test for FMS upsert non-duplication (Property 5)
  ...
  - [ ]* 9.5 Write property test for FMS validation of missing required fields (Property 6)
...
- [ ] 10. Manual Entry Service and forms backend
  - [ ] 10.1 Implement manual Order and Vehicle creation endpoints
  ...
  - [ ] 10.2 Implement edit endpoint for manually entered records
  ...
  - [ ]* 10.3 Write property test for manual form validation atomicity (Property 7)
  ...
  - [ ]* 10.4 Write property test for manual form source assignment (Property 8)
...
- [ ] 11. Upload Service
  - [ ] 11.1 Implement spreadsheet upload ingestion pipeline
  ...
  - [ ] 11.2 Implement downloadable upload templates
  ...
  - [ ]* 11.3 Write property test for spreadsheet upload transactional atomicity (Property 9)
  ...
  - [ ]* 11.4 Write property test for spreadsheet row validation partitioning (Property 10)
...
- [ ] 12. Checkpoint — data ingest services complete
  - Ensure all tests pass, ask the user if questions arise.

- [ ] 13. Optimisation Engine
  - [ ] 13.1 Implement OptimisationRequest builder and OR-Tools CP-SAT solver
  ...
  - [ ] 13.2 Implement pre-solve infeasibility detection and Impossible Order Alerts
  ...
  - [ ] 13.3 Implement optimisation run persistence and concurrency guard
  ...
  - [ ] 13.4 Implement re-optimisation logic (locked route preservation)
  ...
  - [ ] 13.5 Implement priority order flagging for re-optimisation
  ...
  - [ ]* 13.6 Write property test for weight capacity invariant (Property 12)
  ...
  - [ ]* 13.7 Write property test for volume capacity invariant (Property 13)
  ...
  - [ ]* 13.8 Write property test for time window compliance invariant (Property 14)
  ...
  - [ ]* 13.9 Write property test for priority ordering invariant (Property 15)
  ...
  - [ ]* 13.10 Write property test for complete assignment coverage (Property 11)
  ...
  - [ ]* 13.11 Write property test for concurrent optimisation run rejection (Property 27)
  ...
  - [ ]* 13.12 Write property test for locked routes preserved through re-optimisation (Property 25)
...
- [ ] 14. Export Service
  - [ ] 14.1 Implement Delivery Platform export with exponential back-off retry
  ...
  - [ ]* 14.2 Write property test for export retry exponential back-off (Property 28)
...
- [ ] 15. API Gateway / BFF
  - [ ] 15.1 Implement REST API endpoints with JWT authentication middleware
  ...
  - [ ] 15.2 Implement WebSocket hub for real-time dispatcher events
  ...
  - [ ] 15.3 Implement optimisation and re-optimisation API endpoints
  ...
  - [ ] 15.4 Implement alert acknowledgement and listing endpoints
  ...
  - [ ] 15.5 Implement audit log query endpoint (Admin only)
  ...
  - [ ] 15.6 Implement user management endpoints (Admin only)
  ...
  - [ ]* 15.7 Write property test for RBAC out-of-role denial (Property 35)
  ...
  - [ ]* 15.8 Write property test for unauthenticated request denial (Property 36)
...
- [ ] 17. React frontend — map and route views
  - [ ] 17.1 Implement App shell with AuthGuard, Layout, and WebSocket connection
  ...
  - [ ] 17.2 Implement MapView with route polylines, stop markers, and depot markers
  ...
  - [ ] 17.3 Implement RouteSummaryPanel with load utilisation indicators
  ...
  - [ ] 17.4 Implement RouteDetailPanel and StopDetailPanel with selection behaviour
  ...
  - [ ]* 17.5 Write property test for route summary panel metric accuracy (Property 18)
  ...
  - [ ]* 17.6 Write property test for capacity threshold indicator correctness (Property 19)
...
- [ ] 18. React frontend — drag-and-drop reassignment and manual entry
  - [ ] 18.1 Implement drag-and-drop order reassignment in StopList
  ...
  - [ ] 18.2 Implement ManualEntryDrawer with OrderForm and VehicleForm
  ...
  - [ ] 18.3 Implement UploadDrawer with FileDropzone and ValidationResultTable
...
- [ ] 19. React frontend — alert panel, optimisation controls, and audit log
  - [ ] 19.1 Implement persistent AlertPanel with WebSocket-driven updates
  ...
  - [ ] 19.2 Implement OptimiseButton / ReoptimiseButton with progress bar
  ...
  - [ ] 19.3 Implement AuditLogModal (Administrator only)
    - Render tabular audit log with filter controls: `entity_type`, `entity_id`, `from_date`, `to_date`, `acting_user`.
    - Gate behind `role = administrator` check; hide from dispatcher UI.
    - _Requirements: 16.6, 17.3_

  - [ ] 19.4 Implement ConnectivityBanner for OMS, FMS, and Mapping Service warnings
  ...
  - [ ] 19.5 Implement loading indicators for slow operations
...
- [ ] 21. Retention jobs and system health
  - [ ] 21.1 Implement audit log and route retention scheduled jobs
  ...
  - [ ] 21.2 Implement performance monitoring and timeout enforcement
...
- [ ] 22. Infrastructure and deployment configuration
  - [ ] 22.1 Write Docker Compose configuration for local development
  ...
  - [ ] 22.2 Write production deployment configuration (Kubernetes or ECS task definitions)
